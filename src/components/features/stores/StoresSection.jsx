...
const StoresSection = () => {
  ...
  const gameStores = [
    // La Paz
    {
      ...
      logo: import.meta.env.BASE_URL + 'assets/image/stores/brosGame.png',
    ...
    },
    {
      ...
      logo: import.meta.env.BASE_URL + 'assets/image/stores/shadowgame.jpg',
    ...
    // Santa Cruz
    {
      ...
      logo: import.meta.env.BASE_URL + 'assets/image/stores/sharkstcg.jpg',
      phone: "73248263",
    ...
    },
    {
      ...
      logo: import.meta.env.BASE_URL + 'assets/image/stores/juasi.jpg',
      phone: "69038332",
      specialty: "General",
    ...
    },
    {
      ...
      logo: import.meta.env.BASE_URL + 'assets/image/stores/uroloki.jpg',
      phone: "72620510",
      specialty: "General",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/jugateesta.jpg',
      phone: "77669066",
      specialty: "Familiar",
    ...
    // Oruro
    {
      ...
      image: "https://images.unsplash.com/photo-1632501641765-e568d28b0015",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/dadosydragones.jpg',
      phone: "75704175",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/coffearkham.jpg',
      phone: "N/A",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1511512578047-dfb367046420",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/bauldejuegos.jpg',
      phone: "76142380",
      specialty: "General",
    ...
    // Tarija
    {
      ...
      image: "https://images.unsplash.com/photo-1503676382389-4809596d5290",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/mesadragon.jpg',
      phone: "76187558",
      specialty: "General",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/minitoys.jpg',
      phone: "61856234",
      specialty: "General",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1632501641765-e568d28b0015",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/bazinga.jpg',
      phone: "78706666",
      specialty: "General",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/cajadejuegos.jpg',
      phone: "74535305",
      specialty: "General",
      address: "Dirección no disponible",
    ...
    // Sucre
    {
      ...
      image: "https://images.unsplash.com/photo-1511512578047-dfb367046420",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/puntodevictoria.jpg',
      phone: "61892074",
      specialty: "General",
      address: "Dirección no disponible",
    ...
    // Cochabamba
    {
      ...
      description: "Juegos de mesa y eventos especiales",
      image: "https://images.unsplash.com/photo-1503676382389-4809596d5290",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/tinkunagmaes.png',
      phone: "77958996",
      specialty: "General",
      address: "Dirección no disponible",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/magicgames.jpg',
      phone: "N/A",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1632501641765-e568d28b0015",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/mercadererrante.jpg',
      phone: "72219585",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/gameslanding.jpg',
      phone: "74570507",
      specialty: "General",
      address: "Dirección no disponible",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1511512578047-dfb367046420",
      logo: import.meta.env.BASE_URL + 'assets/image/stores/antikuna.png',
      phone: "N/A",
      specialty: "General",
